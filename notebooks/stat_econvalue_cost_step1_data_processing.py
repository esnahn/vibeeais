...
WHERE
    t."사용승인_일" > '19000101' AND  -- for now: maintain old criteria. (다음 내용은 나중을 위해 저장: 지금은 무시할 것) 주의! 2025년 quacklytics 코드와 다름: 사용승인일이 19000101과 같은 경우를 포함해 선별됨
    t."사용승인_일" <= '{upper}' AND
    LENGTH(t."사용승인_일") = 8
"""
...
SELECT
    ...
    "기타_용도" AS "층_기타_용도",
    CAST("면적(㎡)" AS DECIMAL(18,3)) AS "층_면적",
